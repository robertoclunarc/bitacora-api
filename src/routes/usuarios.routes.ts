...
router.get('/', [authenticateJWT, checkRole(1)], getAllUsuarios);
...
router.put('/:login', [authenticateJWT, checkRole(1)], updateUsuario); // Solo administradores pueden modificar usuarios
router.delete('/:login', [authenticateJWT, checkRole(1)], deleteUsuario); // Solo administradores pueden eliminar usuarios
