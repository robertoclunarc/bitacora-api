...
router.post('/', [authenticateJWT, checkRole(1)], createEquipo);
router.put('/:id', [authenticateJWT, checkRole(1)], updateEquipo);
router.delete('/:id', [authenticateJWT, checkRole(1)], deleteEquipo);
